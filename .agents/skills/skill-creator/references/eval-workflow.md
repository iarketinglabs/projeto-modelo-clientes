...
This section covers the full workflow for testing a skill. **This is one continuous sequence — don't stop partway through.** Do NOT use `/skill-test` or any other testing skill.
